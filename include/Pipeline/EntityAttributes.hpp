...
namespace Pipeline
{
   ...
   public:
      ...
      static constexpr char* NPC_DR_DELIVERY = (char*)"dr_delivery";
      static constexpr char* NPC_DR_LOUISE_FOREST = (char*)"dr_louise-forest";
      static constexpr char* NPC_DR_LOUISE_TURRET = (char*)"dr_louise-turret";
