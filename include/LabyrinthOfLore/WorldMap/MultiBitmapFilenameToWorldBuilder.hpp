...
namespace LabyrinthOfLore
{
   namespace WorldMap
   {
      ...
      public:
         MultiBitmapFilenameToWorldBuilder(std::string elevation_bitmap_source_filename="data/bitmaps/the_underworld-elevation.png", std::string tile_type_bitmap_source_filename="data/bitmaps/the_underworld-type.png", float ceiling_height=2.0f, float ground_height=1.0f);
